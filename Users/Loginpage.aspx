       ...
       <table style="width: 351px; height: 200px; background-color: #0000FF; font-size: large; font-weight: bold; color: #FFFFFF;" >
           ...
           <tr>
               <td colspan="2" align="center">
                   <asp:Button ID="btn_login_b" runat="server" Text="Login" Font-Bold="True" OnClick="btn_login_b_Click" />&nbsp&nbsp
                   <asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl="Registration.aspx">Sign Up</asp:HyperLink>
               </td>
